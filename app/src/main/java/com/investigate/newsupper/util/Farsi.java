...
public final class Farsi {
	...
	private final static String szLamAndAlef = Character.toString((char) 0xfedf) + Character.toString((char) 0xfe8e); // Lam
																														// +
																														// Alef

	private final static String szLamStickAndAlef = Character.toString((char) 0xfee0)
	...
	private final static String szLamAndAlefWoosim = Character.toString((char) 0xe1) + Character.toString((char) 0xbb); // Lam
																														// +
																														// Alef

	private final static String szLamStickAndAlefWoosim = Character.toString((char) 0x90)
	...
	static struc[] arrStruc = { new struc((char) 0x630, (char) 0xfeac, (char) 0xfeab, (char) 0xfeac, (char) 0xfeab),
			...
			new struc((char) 0x6cc, (char) 0xfbfd, (char) 0xfef3, (char) 0xfef4, (char) 0xfbfc), // Arabic
																									// yeh
			new struc((char) 0x6c0, (char) 0xfba5, (char) 0xfba4, (char) 0xfba5, (char) 0xfba4) // heh
																								// with
																								// yeh
	};

	static struc[] arrStrucWoosim = { new struc((char) 0x630, (char) 0xb5, (char) 0x82, (char) 0xb5, (char) 0x82),
			...
			new struc((char) 0x6c0, (char) 0xac, (char) 0xe4, (char) 0x93, (char) 0xd5) // heh
																						// with
																						// yeh
	};
	...
	private static final boolean isFromTheSet1(/* WCHAR */char ch) {
		char[] theSet1 = new char[] { (char) 0x62c, (char) 0x62d, (char) 0x62e, (char) 0x647, (char) 0x639,
				(char) 0x63a, (char) 0x641, (char) 0x642, (char) 0x62b, (char) 0x635, (char) 0x636, (char) 0x637,
				(char) 0x643, (char) 0x645, (char) 0x646, (char) 0x62a, (char) 0x644, (char) 0x628, (char) 0x64a,
				(char) 0x633, (char) 0x634, (char) 0x638, (char) 0x67e, (char) 0x686, (char) 0x6a9, (char) 0x6af,
				(char) 0x6cc, (char) 0x626 };
		int i = 0;
		while (i < 28) {
			if (ch == theSet1[i])
				return true;
	...
	private static final boolean isFromTheSet2(/* WCHAR */char ch) {
		char[] theSet2 = new char[] { (char) 0x627, (char) 0x623, (char) 0x625, (char) 0x622, (char) 0x62f,
				(char) 0x630, (char) 0x631, (char) 0x632, (char) 0x648, (char) 0x624, (char) 0x629, (char) 0x649,
				(char) 0x698, (char) 0x6c0 };
		int i = 0;
		while (i < 14) {
			if (ch == theSet2[i])
				return true;
	...
	public static final String ConvertBackToRealFarsi(String In) {
		...
		for (i = 0; i < In.length(); i++) {
			...
			for (j = 0; j < arrStruc.length; j++) {
				if (chIn[i] == arrStruc[j].midGlyph || chIn[i] == arrStruc[j].iniGlyph
						|| chIn[i] == arrStruc[j].endGlyph || chIn[i] == arrStruc[j].isoGlyph) {
	...
	public static final String Convert(String In) {
		...
		for (int i = 0; i < In.length(); i++) {
			/* WCHAR */
			char ch = chIn[i];
			if ((ch >= (char) 0x0621 && ch <= (char) 0x064a) || (ch == (char) 0x067e) || (ch == (char) 0x0686)
					|| (ch == (char) 0x0698) || (ch == (char) 0x06a9) || (ch == (char) 0x06af) || (ch == (char) 0x06cc)
