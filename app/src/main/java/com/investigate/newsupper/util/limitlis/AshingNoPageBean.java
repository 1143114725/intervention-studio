...
public class AshingNoPageBean {
    ...
    public AshingNoPageBean(String etQId,String etId, String contetnId, String contetntext, String operator, String parameter, String circuit, boolean isAshing) {
    	EtQId = etQId;
    	EtId = etId;
        ContetnId = contetnId;
    ...
    public String getEtQId() {
 	...
 	public void setAshing(boolean isAshing) {
 		this.isAshing = isAshing;
 	}
