package com.investigate.newsupper.newphoto;
...
import com.investigate.newsupper.newphoto.adapter.AddImageGridAdapter;
import com.investigate.newsupper.newphoto.controller.SelectPicPopupWindow;
import com.investigate.newsupper.newphoto.photo.Item;
import com.investigate.newsupper.newphoto.photo.PhotoAlbumActivity;
import com.investigate.newsupper.newphoto.photoviewer.photoviewerinterface.ViewPagerActivity;
import com.investigate.newsupper.newphoto.photoviewer.photoviewerinterface.ViewPagerDeleteActivity;
import com.investigate.newsupper.newphoto.util.PictureManageUtil;
      	...
      	gridView.setOnItemClickListener(new OnItemClickListener() {
      		public void onItemClick(AdapterView<?> parent, View v, int position, long id)
      		{
      			if(position==(photoList.size())){
      				...
      				menuWindow.showAtLocation(MainActivity.this.findViewById(R.id.uploadPictureLayout), Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0); //设置layout在PopupWindow中显示的位置
      			}
      			else{
