...
/**
 * 在线答卷界面 参考：https://blog.csdn.net/u012611878/article/details/78838464
 * 
 * @author EraJieZhang
 * @data 2018/11/14
 */
...
//	String url = "http://www.survey-expert.cn/newsurvey/surveyFieldIndex.asp?ID=10395&FeedID=11&PhoneDirect=parent";
	...
	public void initdata(String fid, String sid) {
		String url = "http://www.survey-expert.cn/newsurvey/surveyFieldIndex.asp?ID="+sid+"&FeedID="+fid+"&PhoneDirect=parent";
