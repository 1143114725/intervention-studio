...
public class HtmlTagHandler implements Html.TagHandler {
	private static final String TAG_BLUE_FONT = "span";// "bluefont";
	...
	public void endFont(String tag, Editable output, XMLReader xmlReader) {
		...
		if (!TextUtils.isEmpty(color)) {
			output.setSpan(new ForegroundColorSpan(Color.parseColor(color)),
	...
	private void processAttributes(final XMLReader xmlReader) {
		try {
			Field elementField = xmlReader.getClass().getDeclaredField(
					"theNewElement");
